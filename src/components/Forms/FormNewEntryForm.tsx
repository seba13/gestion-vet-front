      ...
      fetch(`${import.meta.env.VITE_API_URL}/ficha-ingreso`, {
        ...
        .then((json) => {
          if (json.success) {
            setFormAlert({
              typeOf: "success",
              messages: ["Ficha de ingreso registrada correctamente✅"],
            });
            setShowAlert(true);
            setIsSaved(true);
          } else {
            setFormAlert({
              typeOf: "danger",
              messages: ["Error al registrada ficha❌"],
            });
            setShowAlert(true);
          }
        })
              ...
              <label htmlFor="idFichaClinica" className="form-label">
                ...
                <input
                  ...
                  className={`form-control w-75 ${
                    existsEntryForm ? "bg-success" : "bg-danger"
                  }`}
                  id="idFichaClinica"
                  name="idFichaClinica"
